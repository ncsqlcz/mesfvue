...
const Battery = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, Battery.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
Battery.setDefaults = defaults => {
  Battery.defaults = defaults
}

// 显示弹框
Battery.show = (title, options) => {
