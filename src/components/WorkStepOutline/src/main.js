...
const WorkStepOutline = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, WorkStepOutline.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
WorkStepOutline.setDefaults = defaults => {
  WorkStepOutline.defaults = defaults
}

// 显示弹框
WorkStepOutline.show = (title, options) => {
  ...
  return WorkStepOutline(Object.assign({
    title: title
  }, options))
}
// 手动关闭弹框
WorkStepOutline.close = () => {
  this.action = ''
  this.visible = false
}

export default WorkStepOutline
export { WorkStepOutline }
