...
const WorkShop = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, WorkShop.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
WorkShop.setDefaults = defaults => {
  WorkShop.defaults = defaults
}

// 显示弹框
WorkShop.show = (title, options) => {
