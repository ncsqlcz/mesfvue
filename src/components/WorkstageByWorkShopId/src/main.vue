  ...
  <el-dialog :title="title || '选择工序' " :visible.sync="visible" class="mes-dialog" width="40%">
    <el-col class="toolbar hidden">
      <el-form :inline="true" :model="params" @submit.native.prevent class="text-right">
        <el-form-item>
          <el-input v-model="params.workshopName" placeholder="输入关键字" @keyup.native.enter="getDataList" size="small"></el-input>
        </el-form-item>
...
<script>
  ...
  export default {
    name: 'workstage-by-work-shop-Id',
    data () {
      return {
        params: {
          type: 'workstage',
