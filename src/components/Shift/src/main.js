...
const Shift = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, Shift.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
Shift.setDefaults = defaults => {
  Shift.defaults = defaults
}

// 显示弹框
Shift.show = (title, options) => {
