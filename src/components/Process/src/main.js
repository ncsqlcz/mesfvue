...
const Process = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, Process.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
Process.setDefaults = defaults => {
  Process.defaults = defaults
}

// 显示弹框
Process.show = (title, options) => {
