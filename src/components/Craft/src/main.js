...
const Craft = function (options, callback) {
  ...
  return new Promise((resolve, reject) => { // eslint-disable-line
    currentMsg = {
      options: Object.assign({}, defaults, Craft.defaults, options),
      callback: callback,
      resolve: resolve,
      reject: reject
    }
...
// 设置默认配置
Craft.setDefaults = defaults => {
  Craft.defaults = defaults
}

// 显示弹框
Craft.show = (title, options) => {
