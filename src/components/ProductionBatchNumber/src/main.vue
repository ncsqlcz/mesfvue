<!-- 刘川中 2018.6.8 -->
<template>
  <el-dialog :title="title || '选择生产批号' " :visible.sync="visible" class="mes-dialog" width="40%">
    ...
    <el-table :data="list" v-loading="listLoading"
      ...
      <el-table-column prop="production_plan_batch_number" label="生产批号" sortable></el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        queryDraftPlanOutline(para).then((data) => {
          if (data.status === 0) {
