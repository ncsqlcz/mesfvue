  ...
  <el-row style="background-color: transparent">
    ...
    <el-col :span="24">
      <el-col class="toolbar">
        <el-form :inline="true" :model="filters" @submit.native.prevent>
          <el-col :span="4" class="text-left">
            <el-form-item>
              <el-button type="primary" size="medium" @click="handleAdd" icon="el-icon-plus">新增产线</el-button>
            </el-form-item>
          </el-col>
          <el-col :span="20" class="text-right">
            <el-form-item :span="4">
              <el-input v-model.trim="filters.productLineName" size="medium" placeholder="输入产线名称" @keyup.native.enter="getList"></el-input>
            </el-form-item>
            <el-form-item>
      ...
      <el-table :data="list" highlight-current-row
        ...
        <el-table-column prop="product_line_number" label="产线代号" sortable></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      workshopConfig (row) {
        this.$router.push({
          path: '/system/organization/lineWorkshopConfig',
          query: {
            type: 'productLineId',
            id: row.product_line_id,
            title: '产线：' + row.product_line_name
      ...
      handleEdit (row) {
        ...
        this.productLineName = row.product_line_name
          ...
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(() => {
              ...
              if (this.isAddForm) {
                ...
                if (this.productLineName === this.addForm.productLineName) {
                  para.productLineName = ''
                }
