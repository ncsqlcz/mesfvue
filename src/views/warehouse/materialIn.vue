/* * @Author: danqihao * @Date: 2018-04-09 08:47:37 * @Last Modified by: danqihao * @Last Modified time: 2018-04-13 10:15:39
*/
<template>
  <section>
    <el-row class="toolbar">
      ...
      <el-col :span="22">
        ...
        <el-col :span="7">
          <el-date-picker @change="timeChange()" v-model="timesList" type="datetimerange" align="right" size="small" unlink-panels
          ...
          <table>
            ...
            <tbody>
              <tr v-for="(value,index) in selectMaterialList" :key="index">
                ...
                <td>
                  <el-input size="medium" placeholder="请输入内容(必填)" type="number" min=0 :max='value.warehouse_material_record_number' :value='value.warehouse_material_entry_number'
                    @blur="test(value.warehouse_material_record_number,value.warehouse_material_entry_number,index)" v-model="selectMaterialList[index].warehouse_material_entry_number"></el-input>
                </td>
                <td>
