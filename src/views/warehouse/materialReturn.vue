/* * @Author: danqihao * @Date: 2018-04-10 14:04:56 * @Last Modified by: danqihao * @Last Modified time: 2018-04-12 17:17:00
*/
<template>
  <section>
          ...
          <table>
            ...
            <tbody>
              <tr v-for="(value,index) in selectMaterialList" :key="index">
                ...
                <td>
                  <el-input size="medium" placeholder="请输入内容(必填)" type="number" min=0 :value='value.warehouse_material_return_number' @blur="test(value.warehouse_material_return_number,index)"
